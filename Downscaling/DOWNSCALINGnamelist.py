...
UTM = '7N'
#ELA = 1900
normalized_XYZ = True # Scale regression coefficients X,Y,Z by dividing by the max XYZ?
...
NARR_subregions = NARR_subregions_original #Indices of subregions used for precip downscaling, picked manually to omit points on opposite side of divide
...
downscaled_outputs = 'D:/Downscaled_files/Catchment/NARRsubregions_tests/NormalizedXYZ/subregions_original'